    ...
    <div className="min-h-screen bg-[#f4f9f4] font-sans">
      ...
      <main className="max-w-6xl mx-auto text-center pt-16 px-4 relative">
        <h1 className="text-5xl md:text-6xl font-extrabold text-[#1a1a1a] leading-tight tracking-tight">
          ...
          here. It&rsquos plant{' '}
          <span className="bg-[#e2f0d9] px-4 rounded-2xl italic">
            care time!
          </span>
        </h1>

        <p className="mt-6 text-gray-500 max-w-2xl mx-auto text-sm leading-relaxed">
          Your plants are thriving because of you! They&rsquore so happy to have
          your care and attention. It&rsquos time to water them, trim any dry
          leaves, and maybe even give them some extra nutrients.
        </p>
      ...
      <section className="bg-white py-16 px-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Black Stats Card */}
          <div className="md:col-span-2 bg-black text-white p-10 rounded-[2rem] flex flex-col justify-between">
          ...
          {/* Rating Card */}
          <div className="bg-[#86bc25] p-10 rounded-[2rem] text-white flex flex-col justify-between relative overflow-hidden">
            <div>
