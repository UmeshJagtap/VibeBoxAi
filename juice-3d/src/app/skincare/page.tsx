//
// https://github.com/divyashrma18/skincare/blob/main/vite-project/src/components/Hero.jsx
// 
                ...
                <div className="product-grid">
                    <div className="product-item">
                        <div className="product-img">
                            <img src="/images/skincare/m2.png" alt="product 1" />
                        </div>
                        <p>Daily Sunscreen</p>
                    </div>
                    <div className="product-item">
                    ...
                    <div className="product-item">
                        <div className="product-img">
                            <img src="/images/skincare/m3.png" alt="product 3" />
                        </div>
                    ...
                    <div className="product-item">
                        <div className="product-img">
                            <img src="/images/skincare/m4.png" alt="product 4" />
                        </div>
                        <p>Alpha Cleanser</p>
                    </div>
                    <div className="product-item">
                        <div className="product-img">
                            <img ref={m6Ref} src="/images/skincare/m6.png" alt="product 5" />
                        </div>
                        <p>Hair Repair Serum</p>
                    </div>
                    <div className="product-item">
                        <div className="product-img">
                            <img src="/images/skincare/m5.png" alt="product 6" />
                        </div>
                        <p>Radiance Oil</p>
                    </div>
                </div>
            ...
            <div className="s">
                <div className="serum" ref={serumRef}>
                    ...
                    <div className="serum-text">
                        <img src="./images/skincare/drop.png" alt="" className='drop' />
                    ...
                    <div className="serum-img">
                        <img src="/images/skincare/serum.png" alt="Hydrating Serum" />
                    </div>
                </div>
